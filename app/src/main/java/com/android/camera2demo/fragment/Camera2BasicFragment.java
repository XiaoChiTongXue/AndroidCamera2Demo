...
public class Camera2BasicFragment extends Fragment
    ...
    private CaptureRequest.Builder mFrontPreviewRequestBuilder;
    ...
    private CaptureRequest mFrontPreviewRequest;
...
//            Log.v(TAG, "---- onCaptureCompleted();");
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.startPreview).setOnClickListener(this);
        view.findViewById(R.id.stopPreview).setOnClickListener(this);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.v(TAG, "---- setUpCameraOutputs();mCameraCharacteristics: " + mCameraCharacteristics);
